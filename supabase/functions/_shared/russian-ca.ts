// Russian Trusted CA chain (Минцифры). Needed because securepay.tinkoff.ru is signed by
// "Russian Trusted Sub CA", which is not in the default Deno/edge trust store.
export const RUSSIAN_TRUSTED_CA_CERTS: string[] = [
  `-----BEGIN CERTIFICATE-----
