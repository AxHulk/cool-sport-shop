...
const About = () => (
  <div className="container py-12 max-w-3xl mx-auto">
    ...
    <p className="text-lg text-muted-foreground mb-8 text-center">
      āsana — это премиальная спортивная одежда для женщин, которые ценят стиль, комфорт и осознанный подход к спорту.
    </p>
    ...
    <div className="space-y-12">
      <section>
        ...
        <p className="text-muted-foreground">
          ...
          Каждая вещь āsana создана, чтобы вы чувствовали себя уверенно — на тренировке и за её пределами.
